    ...
    <div class="container">
        ...
        <div class="container2">
            <div id="writeField">
                ...
                <div class="post">
                    <input type='button' value='취소' class="CancelBtn" onclick="location.href = 'bord_nowBest.jsp'">
                    <input type='submit' value='도서 등록' class="WriteBtn">
                </div>
            </div>
        </div>
       </form> 
