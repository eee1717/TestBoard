...
<section class="Main">
    ...
    <div class="container">
        <div id="main-header" >
            <div id="main-header-left">
                ...
                <div id="weather">
                    <img src="../img/index/cloud-sun.svg" class="menuIcon">
                </div>
        ...
        <div id="notice">
            <div class="swiper notice-swap"> <!-- 슬라이더-->
                <ul id="notice-left">
                    <li><img src="../img/index/speaker.svg" width="20px" height="20px" class="menuIcon"></li>
                    <li>공지사항</li>
                </ul>
        ...
        <div id="contents-top">
            ...
            <div id="best-humour">
                <table>
                    ...
                    <tr id="humor-img">
                        <td><img src="../img/index/cat1.jpg" alt="베스트유머1"></td>
                        <td><img src="../img/index/dog1.jpg" alt="베스트유머2"></td>
                        <td><img src="../img/index/cat2.jpg" alt="베스트유머3"></td>
                        <td><img src="../img/index/dog2.jpg" alt="베스트유머4"></td>
                        <td><img src="../img/index/cat3.jpg" alt="베스트유머5"></td>
                        <td><img src="../img/index/dog3.jpg" alt="베스트유머6"></td>
                    </tr>
            ...
            <div id="banner">
                <div class="swiper banner">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide banner-slide"><img src="../img/index/banner/banner1.png" alt="광고1">
                        </div>
                        <div class="swiper-slide banner-slide"><img src="../img/index/banner/banner2.png" alt="광고2">
                        </div>
                        <div class="swiper-slide banner-slide"><img src="../img/index/banner/banner3.png" alt="광고3">
                        </div>
                        <div class="swiper-slide banner-slide"><img src="../img/index/banner/banner4.png" alt="광고4">
                        </div>
                    </div>
        ...
        <div id="contents-bottom">
            ...
            <div id="pointshop">
                ...
                <div id="pointshop-table">
                    <table class="item">
                        <tr>
                            <td><img src="../img/pointShop/pointshop.gif"><label>로켓</label></td>
                            <td><img src="../img/index/pointshop-icon1.gif" alt="비 아이콘"><label>비</label></td>
                            <td><img src="../img/index/pointshop-icon2.gif" alt="종이 아이콘"><label>종이</label></td>
                            <td><img src="../img/index/pointshop-icon3.gif" alt="방울 아이콘"><label>방울</label></td>
                        </tr>
                        <tr>
                            <td><img src="../img/index/pointshop-icon4.gif" alt="별 아이콘"><label>별</label></td>
                            <td><img src="../img/index/pointshop-icon5.gif" alt="노이즈 아이콘"><label>노이즈</label></td>
                            <td><img src="../img/index/pointshop-icon6.gif" alt="비 아이콘"><label>비</label></td>
                            <td><img src="../img/index/pointshop-icon7.gif" alt="포켓몬 아이콘"><label>포켓몬</label></td>
                        </tr>
                        <tr>
                            <td><img src="../img/index/pointshop-icon3.gif" alt="방울 아이콘"><label>방울</label></td>
                            <td><img src="../img/index/pointshop-icon2.gif" alt="종이 아이콘"><label>종이</label></td>
                    ...
                    <table>
                        <tr>
                            <td><img src="../img/index/stop.png"></td>
                        </tr>
                        <tr>
                            <td>준비중입니다.</td>
                        </tr>
    ...
    <footer>
        <div id="footer-bottom">
            <div id="footer-logo">
                <img src="../img/sidebar/logo.svg" alt="로고">
            </div>
            <div id="footer-terms">
                서비스 이용약관 | 개인정보 처리방침 | 청소년보호정책 | 이메일주소 무단수집거부 | 이용약관 | <span onclick="goDeveloper()" style="cursor:pointer;">개발자 소개</span> <br>
            ...
            <div id="footer-right">
                <div id="sns">
                    <img src="../img/index/github-square-brands.svg" alt="깃허브">
                    <img src="../img/index/twitter-square-brands.svg" alt="트위터">
                    <img src="../img/index/instagram-square-brands.svg" alt="인스타">
                </div>
                <div>
                    <select>
                        <option>부가 메뉴</option>
